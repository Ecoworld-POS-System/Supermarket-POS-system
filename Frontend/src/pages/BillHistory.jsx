...
export default function BillHistoryPage() {
    ...
    return (
        <AppLayout activeMenu="Bill History" breadcrumb={['EGOTECH WORLD', 'Bill History']}>
            <div className="content-view bg-gray-50 min-h-screen p-6">
                <div className="view-header flex justify-between items-center mb-6">
                    <div>
                        <h1 className="page-title-main text-2xl font-bold text-gray-900">Bill History</h1>
                        <p className="header-summary-subtitle text-sm text-gray-500">Full transaction log • Aug 2026</p>
                    </div>
                    <div style={{ display: 'flex', gap: '12px' }}>
                        <button className="btn-secondary px-4 py-2 border border-gray-300 rounded-lg bg-white text-gray-700 hover:bg-gray-100 flex items-center gap-2 text-sm font-medium" onClick={() => setShowBatchPrintModal(true)}>
                            <Printer size={16} /> Batch Print
                        </button>
                        <button className="btn-primary px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 flex items-center gap-2 text-sm font-medium" onClick={() => setShowExportModal(true)}>
